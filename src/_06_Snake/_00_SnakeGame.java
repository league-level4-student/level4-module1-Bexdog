...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "This is snake, you know how to play";
		
		String[] options = new String[] {"Ultimate", "Expert", "Moderate", "Beginner" };
...
//		down arrow	40
	...
	private void setFoodLocation() {
		...
		int randy1 = new Random().nextInt(WIDTH);
		int randy2 = new Random().nextInt(HEIGHT);
		Location loc = new Location(randy1, randy2);
	...
	private void gameOver() {
		...
		JOptionPane.showMessageDialog(null, "You snake is dead, soon you will be too");
		//3. ask them if they want to play again.
	String again =	JOptionPane.showInputDialog(null, "Do you want to play again?");
		again.toLowerCase();
	if(again.equals("yes")) {
		Location loc = new Location(7, 6);
		snake.reset(loc);
		setFoodLocation();
		try {
			Thread.sleep(500);
...
snake.update();
	...
	if(snake.isHeadCollidingWithBody()||snake.getHeadLocation().x>WIDTH||snake.getHeadLocation().x<0||snake.getHeadLocation().y>HEIGHT||snake.getHeadLocation().y<0) {
